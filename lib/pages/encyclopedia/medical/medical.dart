...
class _MedicalPageState extends State<MedicalPage> {
  ...
  //List<String> tabTitle = ['全部','医院', '药店', '报销流程', '校医院'];
  Future<List>? flist;
  String _selectedValue = '时间排序';
  Future<List> _ReadHandle() async {
    var result = await DioUtil().request("/findbaikeFromDemo",
        method: DioMethod.post,
        data: {"category1": "团购", "campus": location.longitude.value + ',' + location.latitude.value, "orderofBaike": location.tabControl.value});
