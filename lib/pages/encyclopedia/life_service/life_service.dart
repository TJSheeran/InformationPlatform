...
class _LifeservicePageState extends State<LifeservicePage> {
  ...
  Future<List> _ReadHandle() async {
    var result = await DioUtil().request("/findbaikeFromDemo",
        ...
        data: {"category1": "社区服务", "campus": location.longitude.value + ',' + location.latitude.value, "orderofBaike": location.tabControl.value});
  ...
  // Future<List> _ReadHandle() async {
  //   var result = await DioUtil().request("/register",
  //       method: DioMethod.post, data: {"username": "mark", "password": "1111"});
  //   return result;
  // }
  Widget renderCover() {
    return Stack(
